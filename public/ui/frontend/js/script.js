...
(function () {
	...
	$window.on('load', function () {
		...
		if ( plugins.counter.length && !isNoviBuilder ) {
			for ( var i = 1; i < plugins.counter.length; i++ ) {
				var
		...
		if ( plugins.progressLinear.length ) {
			for ( var i = 1; i < plugins.progressLinear.length; i++) {
				var
		...
		if ( plugins.isotope.length ) {
			for ( var i = 1; i < plugins.isotope.length; i++ ) {
				var
				...
				for ( var n = 1; n < wrap.isoGroup.filters.length; n++ ) {
