<x-backend.layouts.master>
    ...
    <div class="card mb-4">
        <div class="card-header">
            ...
            Profiles <a class="btn btn-sm btn-info" href="{{ route('profiles.index') }}">List</a>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    ...
                    td>{{ ++$sl }}</td>
                        ...
                        <td>
                            ...
                            <a class="btn btn-warning btn-sm" href="{{ route('profiles.restore', ['profile' => $profile->id]) }}" >Restore</a>

                            <form style="display:inline" action="{{ route('profiles.delete', ['profile' => $profile->id]) }}" method="post">
                                @csrf
                                @method('delete')
